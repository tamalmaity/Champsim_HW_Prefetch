...
default_spec_instrs = 12
default_gap_instrs = 12
...
default_ps_binary = 'bin/hashed_perceptron-no-no-no-page_stride-lru-1core'
'''
baseline_names = ['Page stride']
baseline_fns = ['page_stride']
baseline_binaries = [default_ps_binary]
'''
